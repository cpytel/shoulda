...
By setting the BENCHMARK environment variable to true when running your tests, additional information about the performance of your tests will be printed.
